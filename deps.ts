export * as base64 from "https://deno.land/std@0.109.0/encoding/base64.ts";
export * as colors from "https://deno.land/std@0.109.0/fmt/colors.ts";
...
export * as uuid from "https://deno.land/std@0.109.0/uuid/mod.ts";
...
export * as gip from "https://cdn.skypack.dev/gitignore-parser";
