...
(function() {
    ...
    return {
        ...
        httpEndpointAvailableAction: httpEndpointAvailableAction,
        LabeledBadge: LabeledBadge,
        TunnelStatePresentation: TunnelStatePresentation,
        TunnelReconnectStrategy: TunnelReconnectStrategy,
        EventSourceTunnelState: EventSourceTunnelState,
        Tunnels: Tunnels,
        UserAgentBus: UserAgentBus,
