...
(function() {
    ...
    return {
        ...
        isEventSourceService: isEventSourceService,
        isFetchService: isFetchService,
        isWebSocketSendService: isWebSocketSendService,
        isWebSocketReceiveService: isWebSocketReceiveService,
        typicalConnectionValidator: typicalConnectionValidator,
        ReconnectionState: ReconnectionState,
        ...
        isWebSocketConnectionHealthy: isWebSocketConnectionHealthy,
        isWebSocketConnectionUnhealthy: isWebSocketConnectionUnhealthy,
        isWebSocketReconnecting: isWebSocketReconnecting,
        isWebSocketErrorEventSupplier: isWebSocketErrorEventSupplier,
        isWebSocketCloseEventSupplier: isWebSocketCloseEventSupplier,
        isWebSocketEndpointUnavailable: isWebSocketEndpointUnavailable,
        WebSocketTunnel: WebSocketTunnel,
        webSocketConnNarrative: webSocketConnNarrative,
