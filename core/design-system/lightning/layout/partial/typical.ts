...
export const clientCargoPartial: ldsGovn.LightningPartial = (layout) => {
  ...
  return `<script>
    ...
    const ${layout.clientCargoPropertyName} = {
      ...
      assets: ${layout.dsCtx.assets.clientCargoValue(layout)},
      navigation: ${layout.dsCtx.navigation.clientCargoValue(layout)},
...
<link rel="stylesheet" href="${layout.dsCtx.assets.dsStylesheet("/lightning-customize.css")}">
<link rel="stylesheet" href="${layout.dsCtx.assets.dsStylesheet("/markdown.auto.css")}">
...
<script src="${layout.dsCtx.assets.dsScript("/lightning-tail.js")}"></script>`;
